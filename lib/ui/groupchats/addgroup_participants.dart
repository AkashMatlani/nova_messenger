...
class AddGroupParticipants extends StatefulWidget {
  ...
  AddGroupParticipants(this.groupData);

  @override
  AddGroupParticipantsState createState() {
    return AddGroupParticipantsState();
  }
}

class AddGroupParticipantsState extends State<AddGroupParticipants> {
  ...
  addParticipantsToGroup() async {
    if (userIdsList.length <= 0) {
      ...
      groupData.name = widget.groupData.name;
      groupData.description = "";
      groupList.contacts = userIdsList;
